...
\node[umlclass] (roster)
 ...
 \nodepart{four}
  \begin{tabular}{l}
   ...
   -- \texttt{void removePlayer(Player p, boolean r)}\\
...
\draw[arrows={-angle 60},thick]
[out=0, in=90]([yshift=0.5cm]maingame.three east) node[right=0.15cm]{1} to [out=-65, in=111](statshistory.text west) node[right]{1};
