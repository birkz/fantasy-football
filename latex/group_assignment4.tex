...
\node[umlclass] (DesignedButton)
 ...
 \nodepart{three}
  \begin{tabular}{l}
   + \texttt{CustomButton orangeStyle(String text, int style, float size)}\\
   + \texttt{CustomButton deleteStyle(String text, int style, float size)}\\
  \end{tabular}
 };
\end{scope}
