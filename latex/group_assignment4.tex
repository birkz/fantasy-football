...
GraphDataPanel needs data from the StatsHistory to draw the graphs. ScorePanel will display this graph as well as the score for each user.
...
% graphdatapanel to statshistory
\draw[arrows={-angle 60},thick] ([yshift=-3pt]graphdatapanel.four east) to [out=20, in=-170]([yshift=5pt]statshistory.text west);
