...
%% ==========================================
\begin{scope}[xshift=0cm,yshift=0cm]
\node[umlclass] (NameChange Panel)
 {\textbf{\large \textit{NameChange Panel}}
 \nodepart{two}
  {\footnotesize
  \begin{tabular}{l} 
   Desc.
...
%% ==========================================
\begin{scope}[xshift=0cm,yshift=0cm]
\node[umlclass] (Roster Panel)
 {\textbf{\large \textit{Roster Panel}}
 \nodepart{two}
  {\footnotesize
  \begin{tabular}{l} 
   Desc.
...
%% ==========================================
\begin{scope}[xshift=0cm,yshift=0cm]
\node[umlclass] (Score Panel)
 {\textbf{\large \textit{Score Panel}}
 \nodepart{two}
  {\footnotesize
  \begin{tabular}{l} 
   Desc.
