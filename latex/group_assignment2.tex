...
%% ==========================================
% user to roster
\draw[arrows={-angle 60},thick] ([yshift=-20pt]user.three east) node[right]{1} to [out=45, in=180](roster.text west) node[above left]{1};

% maingame to user
\draw[arrows={-angle 60},thick]
[out=0, in=90](maingame.three east) node[right]{1} to [out=-70, in=70](user.text east) node[right]{0--N};
...
\node[umlclass,rectangle split parts=2] (jframe)
 {\textbf{\large \textit{JFrame}}
 \nodepart{two}
  {\footnotesize
  \begin{tabular}{l} 
   This class is implemented in Java Swing.
  \end{tabular}}
 };
\end{scope}
...
\node[umlclass,rectangle split parts=2] (jpanel)
...
%% ==========================================
\begin{scope}[xshift=8cm,yshift=0cm]
\node[umlclass,rectangle split parts=2] (startpanel)
 {\textbf{\large \textit{StartPanel}}
 \nodepart{two}
  {\footnotesize
  \begin{tabular}{l} 
   Panel that shows up that the start of the game.\\
   It displays a user creation area.
  \end{tabular}}
 \nodepart{three}
  \begin{tabular}{l}
...
\node[umlclass,rectangle split parts=3] (marketpanel)
...
\node[umlclass,rectangle split parts=2] (rosterpanel)
...
%% FieldViewerPanel
%% ==========================================
\begin{scope}[xshift=0cm,yshift=-6.8cm]
\node[umlclass,rectangle split parts=2] (fieldpanel)
...
\node[umlclass,rectangle split parts=2] (leaguepanel)
...
\node[umlclass,rectangle split parts=2] (actionlistener)
...
%% Handle Buttons
%% ==========================================
\begin{scope}[xshift=0cm,yshift=-10.5cm]
